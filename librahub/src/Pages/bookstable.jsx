...
const BooksTable = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    await updateDoc(bookRef, {
      ...
      coverUrl: currentBook.coverUrl ||currentBook.image
    });
          ...
          <tbody>
            {books.map((book) => (
              <tr key={book.id}>
                ...
                <td>
                  <img 
                    src={book.coverUrl || book.image  || "https://via.placeholder.com/50x70"} 
                    alt="cover" 
                ...
                <td>
                  ...
                  <button className="print-btn" onClick={() => printCode(book)}>
                    Print
                  </button>
